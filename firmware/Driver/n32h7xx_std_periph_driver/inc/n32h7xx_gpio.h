...
#ifndef __N32H7XX_GPIO_H__
#define __N32H7XX_GPIO_H__
...
/** Coding rules
*\*\ bit[31:24]: FF---> The current IO is high-speed IO
*\*\ bit[23:16]: FF---> Enable DSP/DSN Register, 00---> Disable DSP/DSN Register
**/
/* High Speed IO:
 * GPIOA: PA7, PA5, PA4
 ...
 */
#define GPIO_HS_IO_DC_1mA                   ((uint32_t)(0xFF000000U | GPIO_DS_2mA))
#define GPIO_HS_IO_DC_2mA                   ((uint32_t)(0xFFFF0000U | GPIO_DS_2mA))
#define GPIO_HS_IO_DC_4mA                   ((uint32_t)(0xFF000000U | GPIO_DS_4mA))
#define GPIO_HS_IO_DC_5mA                   ((uint32_t)(0xFFFF0000U | GPIO_DS_4mA))
#define GPIO_HS_IO_DC_8mA                   ((uint32_t)(0xFF000000U | GPIO_DS_8mA))
#define GPIO_HS_IO_DC_12mA                  ((uint32_t)(0xFF000000U | GPIO_DS_12mA))
...
#define AFIO_ANAEN_PA0_C             (AFIO_ANAEN_CFG0_PA0_C_ANAEN)
#define AFIO_ANAEN_PA0               (AFIO_ANAEN_CFG0_PA0ANAEN)
#define AFIO_ANAEN_PA1_C             (AFIO_ANAEN_CFG0_PA1_C_ANAEN)
#define AFIO_ANAEN_PA1               (AFIO_ANAEN_CFG0_PA1ANAEN)
#define AFIO_ANAEN_PA2               (AFIO_ANAEN_CFG0_PA2ANAEN)
#define AFIO_ANAEN_PA3               (AFIO_ANAEN_CFG0_PA3ANAEN)
#define AFIO_ANAEN_PA4               (AFIO_ANAEN_CFG0_PA4ANAEN)
#define AFIO_ANAEN_PA5               (AFIO_ANAEN_CFG0_PA5ANAEN)
#define AFIO_ANAEN_PA6               (AFIO_ANAEN_CFG0_PA6ANAEN)
#define AFIO_ANAEN_PA7               (AFIO_ANAEN_CFG0_PA7ANAEN)

#define AFIO_ANAEN_PB0               (AFIO_ANAEN_CFG1_PB0ANAEN)
#define AFIO_ANAEN_PB1               (AFIO_ANAEN_CFG1_PB1ANAEN)

#define AFIO_ANAEN_PC0               (AFIO_ANAEN_CFG2_PC0ANAEN)
#define AFIO_ANAEN_PC1               (AFIO_ANAEN_CFG2_PC1ANAEN)
#define AFIO_ANAEN_PC2               (AFIO_ANAEN_CFG2_PC2ANAEN)
#define AFIO_ANAEN_PC2_C             (AFIO_ANAEN_CFG2_PC2_C_ANAEN)
#define AFIO_ANAEN_PC3               (AFIO_ANAEN_CFG2_PC3ANAEN)
#define AFIO_ANAEN_PC3_C             (AFIO_ANAEN_CFG2_PC3_C_ANAEN)
#define AFIO_ANAEN_PC4               (AFIO_ANAEN_CFG2_PC4ANAEN)
#define AFIO_ANAEN_PC5               (AFIO_ANAEN_CFG2_PC5ANAEN)
#define AFIO_ANAEN_PC6               (AFIO_ANAEN_CFG2_PC6ANAEN)
#define AFIO_ANAEN_PC8               (AFIO_ANAEN_CFG2_PC8ANAEN)
#define AFIO_ANAEN_PC13              (AFIO_ANAEN_CFG2_PC13ANAEN)

#define AFIO_ANAEN_PF3               (AFIO_ANAEN_CFG3_PF3ANAEN)
#define AFIO_ANAEN_PF4               (AFIO_ANAEN_CFG3_PF4ANAEN)
#define AFIO_ANAEN_PF5               (AFIO_ANAEN_CFG3_PF5ANAEN)
#define AFIO_ANAEN_PF6               (AFIO_ANAEN_CFG3_PF6ANAEN)
#define AFIO_ANAEN_PF7               (AFIO_ANAEN_CFG3_PF7ANAEN)
#define AFIO_ANAEN_PF8               (AFIO_ANAEN_CFG3_PF8ANAEN)
#define AFIO_ANAEN_PF9               (AFIO_ANAEN_CFG3_PF9ANAEN)
#define AFIO_ANAEN_PF10              (AFIO_ANAEN_CFG3_PF10ANAEN)
#define AFIO_ANAEN_PF11              (AFIO_ANAEN_CFG3_PF11ANAEN)
#define AFIO_ANAEN_PF12              (AFIO_ANAEN_CFG3_PF12ANAEN)
#define AFIO_ANAEN_PF13              (AFIO_ANAEN_CFG3_PF13ANAEN)
#define AFIO_ANAEN_PF14              (AFIO_ANAEN_CFG3_PF14ANAEN)

#define AFIO_ANAEN_PH2               (AFIO_ANAEN_CFG4_PH2ANAEN)
#define AFIO_ANAEN_PH3               (AFIO_ANAEN_CFG4_PH3ANAEN)
#define AFIO_ANAEN_PH4               (AFIO_ANAEN_CFG4_PH4ANAEN)
#define AFIO_ANAEN_PH5               (AFIO_ANAEN_CFG4_PH5ANAEN)

#define AFIO_ANAEN_PI8               (AFIO_ANAEN_CFG5_PI8ANAEN)
#define AFIO_ANAEN_PI15              (AFIO_ANAEN_CFG5_PI15ANAEN)

#define AFIO_ANAEN_PJ0               (AFIO_ANAEN_CFG6_PJ0ANAEN)
#define AFIO_ANAEN_PJ3               (AFIO_ANAEN_CFG6_PJ3ANAEN)
#define AFIO_ANAEN_PJ4               (AFIO_ANAEN_CFG6_PJ4ANAEN)
#define AFIO_ANAEN_PJ5               (AFIO_ANAEN_CFG6_PJ5ANAEN)
#define AFIO_ANAEN_PJ6               (AFIO_ANAEN_CFG6_PJ6ANAEN)
#define AFIO_ANAEN_PJ7               (AFIO_ANAEN_CFG6_PJ7ANAEN)
...
#define ADC_SW_PA0_C_ADC2_INN1              (AFIO_ADCSW_CFG_SWPA0_C_1)
#define ADC_SW_PA0_C_ADC1_INP0              (AFIO_ADCSW_CFG_SWPA0_C_2)
#define ADC_SW_PA0_C_ADC1_INN1              (AFIO_ADCSW_CFG_SWPA0_C_3)
...
#define ADC_SW_PC2_C_ADC2_INN1              (AFIO_ADCSW_CFG_SWPC2_C_1)
#define ADC_SW_PC2_C_ADC3_INP0              (AFIO_ADCSW_CFG_SWPC2_C_2)
#define ADC_SW_PC2_C_ADC3_INN1              (AFIO_ADCSW_CFG_SWPC2_C_3)
...
#define ADC_SW_PC3_C_ADC3_INP1              (AFIO_ADCSW_CFG_SWPC3_C_1)
...
typedef enum 
{
    AFIO_HIGH_SPEED_IO_PA4 = 0,
    AFIO_HIGH_SPEED_IO_PA5 = 1, 
    AFIO_HIGH_SPEED_IO_PA7, 
    AFIO_HIGH_SPEED_IO_PB5, 
    AFIO_HIGH_SPEED_IO_PB6, 
    AFIO_HIGH_SPEED_IO_PB14,
    AFIO_HIGH_SPEED_IO_PB15,
    AFIO_HIGH_SPEED_IO_PC0,
    AFIO_HIGH_SPEED_IO_PC2,
    AFIO_HIGH_SPEED_IO_PC3,
    AFIO_HIGH_SPEED_IO_PC4,
    AFIO_HIGH_SPEED_IO_PC5,
    AFIO_HIGH_SPEED_IO_PC12,
    AFIO_HIGH_SPEED_IO_PD0,
    AFIO_HIGH_SPEED_IO_PD1,
    AFIO_HIGH_SPEED_IO_PD2,
    AFIO_HIGH_SPEED_IO_PD8,
    AFIO_HIGH_SPEED_IO_PD9,
    AFIO_HIGH_SPEED_IO_PD10,
    AFIO_HIGH_SPEED_IO_PD14,
    AFIO_HIGH_SPEED_IO_PD15,
    AFIO_HIGH_SPEED_IO_PE0,
    AFIO_HIGH_SPEED_IO_PE1,
    AFIO_HIGH_SPEED_IO_PE7,
    AFIO_HIGH_SPEED_IO_PE8,
    AFIO_HIGH_SPEED_IO_PE9,
    AFIO_HIGH_SPEED_IO_PE10,
    AFIO_HIGH_SPEED_IO_PE11,
    AFIO_HIGH_SPEED_IO_PE12,
    AFIO_HIGH_SPEED_IO_PE13,
    AFIO_HIGH_SPEED_IO_PE14,
    AFIO_HIGH_SPEED_IO_PE15,

    AFIO_HIGH_SPEED_IO_PF0,
    AFIO_HIGH_SPEED_IO_PF1,
    AFIO_HIGH_SPEED_IO_PF2,
    AFIO_HIGH_SPEED_IO_PF3,
    AFIO_HIGH_SPEED_IO_PF4,
    AFIO_HIGH_SPEED_IO_PF5,
    AFIO_HIGH_SPEED_IO_PF11,
    AFIO_HIGH_SPEED_IO_PF12,
    AFIO_HIGH_SPEED_IO_PF13,
    AFIO_HIGH_SPEED_IO_PF14,
    AFIO_HIGH_SPEED_IO_PF15,
    AFIO_HIGH_SPEED_IO_PG0,
    AFIO_HIGH_SPEED_IO_PG1,
    AFIO_HIGH_SPEED_IO_PG2,
    AFIO_HIGH_SPEED_IO_PG4,
    AFIO_HIGH_SPEED_IO_PG5,
    AFIO_HIGH_SPEED_IO_PG8,
    AFIO_HIGH_SPEED_IO_PG15,
    AFIO_HIGH_SPEED_IO_PH2,
    AFIO_HIGH_SPEED_IO_PH3,
    AFIO_HIGH_SPEED_IO_PH5,
    AFIO_HIGH_SPEED_IO_PH6,
    AFIO_HIGH_SPEED_IO_PH7,
    AFIO_HIGH_SPEED_IO_PH8,
    AFIO_HIGH_SPEED_IO_PH9,
    AFIO_HIGH_SPEED_IO_PH10,
    AFIO_HIGH_SPEED_IO_PH11,
    AFIO_HIGH_SPEED_IO_PH12,
    AFIO_HIGH_SPEED_IO_PH13,
    AFIO_HIGH_SPEED_IO_PH14,
    AFIO_HIGH_SPEED_IO_PH15,
    AFIO_HIGH_SPEED_IO_PI0,

    AFIO_HIGH_SPEED_IO_PI1,
    AFIO_HIGH_SPEED_IO_PI2,
    AFIO_HIGH_SPEED_IO_PI3,
    AFIO_HIGH_SPEED_IO_PI4,
    AFIO_HIGH_SPEED_IO_PI5,
    AFIO_HIGH_SPEED_IO_PI6,
