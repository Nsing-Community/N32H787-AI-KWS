 ...
 */#ifndef __N32H7XX_ADC_H__
#define __N32H7XX_ADC_H__
...
#define ADC_DATA_RES_10BIT                        (0x00000000UL)
...
#define ADC2_Channel_16_PJ0_PJ5                   (ADC_CH_16)  //User can select one of PJ0 PJ5 and DAC135 to ADC2_CH16
#define ADC2_Channel_17_DAC246                    (ADC_CH_17)
#define ADC2_Channel_17_PI15                      (ADC_CH_17)  //User can select one of PI15 or and DAC246 to ADC2_CH17
...
#define ADC3_Channel_17_PI15                      (ADC_CH_17)  //User can select one of PI15 and VBAT/4 to ADC3_CH17
#define ADC3_Channel_18_Temperture_Sensor         (ADC_CH_18)
#define ADC3_Channel_18_PJ3_PJ6                   (ADC_CH_18)  //User can select one of PJ3 PJ6 and TS to ADC3_CH18
#define ADC3_Channel_19_VREFINT                   (ADC_CH_19)
#define ADC3_Channel_19_PJ4_PJ7                   (ADC_CH_19)  //User can select one of PJ4 PJ7 and VREFINT to ADC3_CH19
