 ...
 */#ifndef __N32H7XX_XSPI_H__
#define __N32H7XX_XSPI_H__
...
#define XIP_WAIT_CYCLES_4             ((uint32_t)0x00008000)
...
{		
    ...
    uint32_t WTOC;
 	...
 	/*XSPI_XIP_WRITE_INCR_INST*/
	uint32_t INCRWRINST;
	/* XSPI_XIP_WRITE_WRAP_INST */
	uint32_t WRAPWRINST;
    /*XSPI_XIP_CTRL*/
    uint32_t XIP_FRF;
