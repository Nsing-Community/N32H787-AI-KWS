...
/**
 * @file n32h7xx_shrtim.h
 * @author Nations
 * @version From N32H7xx_Library.1.2.0
 *
 * @copyright Copyright (c) 2025, Nations Technologies Inc. All rights reserved.
 */
#ifndef N32H7XX_SHRTIM_H
#define N32H7XX_SHRTIM_H
...
**/
#define SHRTIM_OUT_NO_IDLE             0x00000000U            /* The output is not affected by the burst mode operation */
#define SHRTIM_OUT_IDLE_WHEN_BURST     (SHRTIM_TXOUT_IDLEM1)     /* The output is in idle state when requested by the burst mode controller */ 
...
#define SHRTIM_FALT_SRC_DSMU                 SHRTIM_FALTIN2_FALT1SRC1 | SHRTIM_FALTIN1_FALT1SRC0/* Fault source 4, Fault input is DSMU */ 
