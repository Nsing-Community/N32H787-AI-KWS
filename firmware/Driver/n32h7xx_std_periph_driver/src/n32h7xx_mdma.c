...
void MDMA_ControllerSoftReset(MDMA_Module *const MDMAy)
{
    ...
    while ((READ_BIT(MDMAy->SWRST, MDMA_SWRST_RSTREQ)) == 1U)
    {
...
{
    MDMA_ChInitParam->SrcMasterSel       = (uint64_t)MDMA_CH_MASTER_1;
    MDMA_ChInitParam->DstMasterSel       = (uint64_t)MDMA_CH_MASTER_1;
    MDMA_ChInitParam->SrcAddrInc         = (uint64_t)MDMA_CH_ADDRESS_COUNT_MODE_INCREMENT;
    MDMA_ChInitParam->DstAddrInc         = (uint64_t)MDMA_CH_ADDRESS_COUNT_MODE_INCREMENT;
    MDMA_ChInitParam->SrcTfrWidth        = (uint64_t)MDMA_CH_TRANSFER_WIDTH_32;
    MDMA_ChInitParam->DstTfrWidth        = (uint64_t)MDMA_CH_TRANSFER_WIDTH_32;
    MDMA_ChInitParam->SrcBurstTranLen    = (uint64_t)MDMA_CH_BURST_TRAN_LEN_1;
    MDMA_ChInitParam->DstBurstTranLen    = (uint64_t)MDMA_CH_BURST_TRAN_LEN_1;
